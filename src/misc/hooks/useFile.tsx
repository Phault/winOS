...
export function useFile(fileSystem: FSModule, path: string, options?: FileOptions): [Buffer | string, Dispatch<SetStateAction<Buffer | string>>] {
    ...
    const writeData = useCallback((data: any) => {
