...
export function CreateNewItems({ path }: { path: string }) {
  ...
  return (
    <Fragment>
      ...
      <Item>Briefcase</Item>
      <Item
        onClick={() => createNewFile(fileSystem, path, 'New Bitmap Image.bmp')}>
        Bitmap Image
      </Item>
      <Item
        onClick={() =>
          createNewFile(fileSystem, path, 'New Wordpad Document.doc')
        }>
        Wordpad Document
      </Item>
      <Item
        onClick={() =>
          createNewFile(fileSystem, path, 'New Rich Text Document.rtf')
        }>
        Rich Text Document
      </Item>
      <Item
        onClick={() =>
          createNewFile(fileSystem, path, 'New Text Document.txt')
        }>
        Text Document
      </Item>
      <Item
        onClick={() => createNewFile(fileSystem, path, 'New Wave Sound.wav')}>
        Wave Sound
      </Item>
      <Item
        onClick={() =>
          createNewFolder(fileSystem, path, 'New Compressed Folder.zip')
        }>
